  ...
  return (
    <div id="bn-root">
      <div
        ...
        greeting_message="สวัสดีค่ะ! ยินดีต้อนรับสู่ Modern Trust แพลตฟอร์มจัดการที่พักอาศัยยุคใหม่ กำลังมองหาห้องพักที่ถูกใจ หรืออยากฝากปล่อยเช่าห้องอยู่หรือเปล่าคะ? ทักมาพูดคุยได้เลยนะคะ พร้อมช่วยเหลือตลอด 24 ชั่วโมงค่ะ"
        default_open="false"
      />
    </div>
  );
