export type Listing = {
  ...
  amenities: string[];
  description: string;
  landlord: { name: string; verified: boolean; avatar: string };
};
...
export const bookings = [
  { id: "b1", listingId: "1", status: "confirmed", checkIn: "2026-06-01", checkOut: "2026-12-01", total: 96000 },
  { id: "b2", listingId: "3", status: "pending", checkIn: "2026-07-15", checkOut: "2027-01-15", total: 120000 },
  { id: "b3", listingId: "5", status: "cancelled", checkIn: "2026-04-10", checkOut: "2026-10-10", total: 87000 },
];
